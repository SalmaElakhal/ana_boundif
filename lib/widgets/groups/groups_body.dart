                ...
                Expanded(
                  child: Padding(
                    padding: EdgeInsets.only(
                        left: 20.0, top: 25.0, right: 10.0, bottom: 10.0),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(
                            ...
                            child: ElevatedButton(
                              ...
                              style: ElevatedButton.styleFrom(
                                padding: EdgeInsets.symmetric(
                                    vertical:
                                        12.0), // Ajuste la hauteur du bouton
                                shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(20.0),
                                ),
                                backgroundColor: Color.fromARGB(255, 243, 228,
                                    228), // Arrière-plan vert clair
                              ),
                              child: Text(
                                'Rejoindre',
                                style: TextStyle(
                                  color: Color.fromARGB(255, 237, 142,
                                      94), // Texte en vert sombre
                                  fontSize: 16.0,
                                ),
                              ),
                            ),
